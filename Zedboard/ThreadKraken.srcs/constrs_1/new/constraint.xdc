...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y11  [get_ports {kypd_col[0]}];  # "JA1"
#set_property PACKAGE_PIN AA11 [get_ports {kypd_col[1]}];  # "JA2"
#set_property PACKAGE_PIN Y10  [get_ports {kypd_col[2]}];  # "JA3"
#set_property PACKAGE_PIN AA9  [get_ports {kypd_col[3]}];  # "JA4"
#set_property PACKAGE_PIN AB11 [get_ports {kypd_row[0]}];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports {kypd_row[1]}];  # "JA8"
#set_property PACKAGE_PIN AB9  [get_ports {kypd_row[2]}];  # "JA9"
#set_property PACKAGE_PIN AA8  [get_ports {kypd_row[3]}];  # "JA10"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {run_trd[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {run_trd[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {run_trd[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {run_trd[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {run_trd[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {run_trd[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {run_trd[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {run_trd[7]}];  # "LD7"
...
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN P16 [get_ports main_switch];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports rst_b];  # "BTND"
#set_property PACKAGE_PIN N15 [get_ports send_b];  # "BTNL"
#set_property PACKAGE_PIN R18 [get_ports setpage_b];  # "BTNR"
...
## ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN F22 [get_ports {digit[0]}];  # "SW0"
#set_property PACKAGE_PIN G22 [get_ports {digit[1]}];  # "SW1"
#set_property PACKAGE_PIN H22 [get_ports {digit[2]}];  # "SW2"
#set_property PACKAGE_PIN F21 [get_ports {digit[3]}];  # "SW3"
#set_property PACKAGE_PIN H19 [get_ports {SW4}];  # "SW4"
#set_property PACKAGE_PIN H18 [get_ports {SW5}];  # "SW5"
#set_property PACKAGE_PIN H17 [get_ports {page[0]}];  # "SW6"
#set_property PACKAGE_PIN M15 [get_ports {page[1]}];  # "SW7"
